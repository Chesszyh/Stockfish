...
python easy_train.py \
    ...
    --features="HalfKAv2_hm^" # "HalfKP"

# 记得及时调整训练和测试参数！
# Book:
# /home/chesszyh/Project/stockfish/nnue-pytorch/scripts/easy_train_data/books/UHO_Lichess_4852_v1.epd \
# --build-engine-arch=x86-64-bmi2? 
# "HalfKP"目前暂不支持：
# File "/home/chesszyh/Project/stockfish/nnue-pytorch/scripts/easy_train_data/experiments/experiment_test/nnue-pytorch/halfkp.py", line 33, in get_initial_psqt_features
